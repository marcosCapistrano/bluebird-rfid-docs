...
public class RFConfigFragment extends Fragment {
    ...
    public void onStart() {
        ...
        mReader = BTReader.getReader(mContext, mRFConfigHandler);
        if (mReader != null && mReader.BT_GetConnectState() == SDConsts.BTConnectState.CONNECTED) {
            ...
            mLBTEditText.setText(Integer.toString(mReader.RF_GetLBTSValue()));//LBT
            if(mReader.SD_GetModel() == SDConsts.MODEL.RFR900) {
                mChannelsSpin.setVisibility(View.GONE);
                mSetChannelsBt.setVisibility(View.GONE);
                mGetChannelsBt.setVisibility(View.GONE);
            }
        }
        super.onStart();
    }
...
//                    Toast.makeText(mContext, "GetEnableChannels result = " + channels, Toast.LENGTH_SHORT).show();
                ...
                String[] c = mReader.RF_GetDefaultChannels();
                String[] channelsSort1 = new String[c.length];
                String strChannels = "";
                if(c == null) {
                ...
                toast0.show();
                //[20250417]SQA:0010362->
//                    Toast.makeText(mContext, "GetDefaultChannels result = " + strChannels, Toast.LENGTH_SHORT).show();
            }
        }
    };
