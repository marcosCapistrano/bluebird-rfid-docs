...
public class SBBarcodeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mParamChar = ArrayAdapter.createFromResource(mContext, R.array.param_array, android.R.layout.simple_spinner_dropdown_item);
        ...
        mPreTextChar = ArrayAdapter.createFromResource(mContext, R.array.bar_pre_text_array, android.R.layout.simple_spinner_dropdown_item);
        ...
        mScannerModeChar = ArrayAdapter.createFromResource(mContext, R.array.scanner_mode_array, android.R.layout.simple_spinner_dropdown_item);
    ...
    private OnClickListener buttonListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //[20250825]Add barcode/camera info->
                ...
                if (edit != null)
                    str = edit.toString();
                ret = mReader.SB_SetBarcodePresetValue(mPreTextSpin.getSelectedItemPosition(), str);
