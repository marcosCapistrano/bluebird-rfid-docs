...
public class BTConnectivityFragment extends Fragment {
    ...
    //+NFC/QR
    private Button mNfcConnectBt;
    private Button mBarcodeConnectBt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //+NFC/QR
        mNfcConnectBt = (Button)v.findViewById(R.id.bt_nfc_connect);
        mNfcConnectBt.setOnClickListener(buttonListener);

        mBarcodeConnectBt = (Button)v.findViewById(R.id.bt_qr_connect);
        mBarcodeConnectBt.setOnClickListener(buttonListener);
    ...
    private OnClickListener buttonListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(id == R.id.bt_nfc_connect){
                ...
                mainActivity.callNFCFrag();
            }else if(id == R.id.bt_qr_connect){
                if (mReader != null) {
                    if (!mReader.BT_IsEnabled())
                        mReader.BT_Enable();
                }
                mainActivity.callQRFrag();
