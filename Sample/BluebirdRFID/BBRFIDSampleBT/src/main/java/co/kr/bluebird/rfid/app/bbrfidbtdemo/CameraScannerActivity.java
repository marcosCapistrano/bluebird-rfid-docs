...
public class CameraScannerActivity extends Activity implements DecoratedBarcodeView.TorchListener{
    ...
    public void onBackPressed() {
        super.onBackPressed();
        CameraBarcodeMainActivity ca = (CameraBarcodeMainActivity)CameraBarcodeMainActivity.mCameraBarcodeMainActivity;
        ca.finish();
    }
